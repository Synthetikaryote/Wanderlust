...
//		kCGEventTapDisabledByUserInput = 0xFFFFFFFF
	...
	[DllImport("/System/Library/Frameworks/Quartz.framework/Versions/Current/Quartz")]
	private static extern uint CGCreateEvent(int? source);
	[DllImport("/System/Library/Frameworks/Quartz.framework/Versions/Current/Quartz")]
	private static extern void CGReleaseEvent(uint eventRef);
	[DllImport("/System/Library/Frameworks/Quartz.framework/Versions/Current/Quartz")]
	...
	public static void SetCursorPosition(int x, int y) {
		...
		SetCursorPos(x, y);
#elif UNITY_EDITOR_OSX || UNITY_STANDALONE_OSX
		MouseEvent(_CGEventType.MouseMoved, new CGPoint(x, y))
#endif
	}
}
